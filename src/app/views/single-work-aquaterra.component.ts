...
@Component({
  	...
  	templateUrl: 'single-work-aquaterra.component.html',
  	animations: [ fadeInOutAnimation ]
})
export class SingleWorkAquaterraComponent implements OnInit, OnDestroy, AfterViewInit {
	...
	constructor(
		...
		this._bgColorClass = 'bg-color-aqua-green'
	}
