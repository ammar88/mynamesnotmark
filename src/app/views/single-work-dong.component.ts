...
@Component({
  	...
  	templateUrl: 'single-work-dong.component.html',
  	animations: [ fadeInOutAnimation ]
})
export class SingleWorkDongComponent implements OnInit, OnDestroy, AfterViewInit {
	...
	constructor(
		...
		this._bgColorClass = 'bg-color-dong-red'
	}
