...
@Component({
  	...
  	templateUrl: 'single-work-edge.component.html',
  	animations: [ fadeInOutAnimation ]
})
export class SingleWorkEdgeComponent implements OnInit, OnDestroy, AfterViewInit {
	...
	constructor(
		...
		this._bgColorClass = 'bg-color-black'
	}
