...
@Component({
  	...
  	templateUrl: 'single-work-inition.component.html',
  	animations: [ fadeInOutAnimation ]
})
export class SingleWorkInitionComponent implements OnInit, OnDestroy, AfterViewInit {
	...
	constructor(
		...
		this._bgColorClass = 'bg-color-inition-pink'
	}
